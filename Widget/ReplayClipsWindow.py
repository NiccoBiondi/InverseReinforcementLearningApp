...
class ReplayClipsWindow(QDialog):
    def __init__(self, path):
        ...
        # Define 
        self._display = Display(self._model.timer, self._model)
...
def ReplayClipsWindowModel(QObject):
    def __init__(self, path):
        super.__init__()
        ...
        # Deinf variable for diplay clips
    ...
    def load_image(self):
        imgs = []
        for img in sorted(os.listdir(self.path)):
            if '.png' in img:
...
def ReplayClipsWindowController(QObject):

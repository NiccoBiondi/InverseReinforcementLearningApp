...
class Ui_SetupModel(object):
    def setupUi(self, SetupModel):
        ...
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.ok_button)
        self.defaultButton = QtWidgets.QPushButton(SetupModel)
        self.defaultButton.setObjectName("defaultButton")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.defaultButton)

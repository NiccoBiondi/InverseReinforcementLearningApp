...
class Ui_SetupModel(object):
    ...
    def retranslateUi(self, SetupModel):
        ...
        self.annotation.setItemText(2, _translate("SetupModel", "40"))
        self.annotation.setItemText(3, _translate("SetupModel", "60"))
        self.annotation.setItemText(4, _translate("SetupModel", "80"))
        self.annotation.setItemText(5, _translate("SetupModel", "100"))

...
class Ui_historyWindow(object):
    ...
    def retranslateUi(self, historyWindow):
        ...
        self.annotationList.headerItem().setText(1, _translate("historyWindow", "Clip 1"))
        self.annotationList.headerItem().setText(2, _translate("historyWindow", "Clip 2"))
        self.annotationList.headerItem().setText(3, _translate("historyWindow", "Preferencies"))

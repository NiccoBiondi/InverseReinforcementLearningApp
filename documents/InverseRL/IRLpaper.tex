...
\author{\IEEEauthorblockN{Giulio Bazzanti, Niccolò Biondi}
...
\input{sections/01Introduction.tex}     % Bazza
\input{sections/02IRL.tex}              % Bazza
\input{sections/03Method.tex}           % Nicco 


\input{sections/04Application.tex}      % Bazza
\input{sections/05Results.tex}          % Nicco 

\input{sections/06Conclusions.tex}      

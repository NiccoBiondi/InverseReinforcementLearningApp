...
\begin{columns}
        ...
        \includemedia[width=0.7\linewidth, keepaspectratio, noplaybutton, activate=pageopen,
...
\begin{columns}
        ...
        \end{column}
        \begin{column}{0.4\textwidth}
            \includemedia[width=0.7\linewidth, keepaspectratio, passcontext, activate=pageopen,

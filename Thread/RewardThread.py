...
class RewardThread(QThread):
    ...
    def run(self):
        ...
        save_reward_weights(self._model.reward_model, self._model.auto_save_folder, self._model.weight_path, self._model.model_parameters['lr'], self._model.model_parameters['K'])
